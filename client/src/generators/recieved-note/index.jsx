...
function RecieveNotePDF({ bill }) {
  return (
    <Document>
      <Page size='A4' style={styles.page}>
        <Text style={{ fontSize: 10, textAlign: 'center', textDecoration: 'underline' }}>RECIEVE NOTE</Text>
        <Text style={{ fontSize: 8, textAlign: 'center', marginBottom: 12, }}>(For office use only)</Text>
        ...
        <View style={{ borderTop: '1 solid black' }} wrap={false}>
