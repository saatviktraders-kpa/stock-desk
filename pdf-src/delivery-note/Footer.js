  ...
  return (
    <>
      ...
      <View style={{ borderTop: '1 solid black', marginTop: 12 }} wrap={false}>
        ...
        <Text style={{ fontSize: 10, marginTop: 6 }}>I, on behalf of {buyer.name}, acknowledge that I have recieved the items regarding Bill No.: {data.billNo} in proper condition.</Text>
        <View wrap={false} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 }}>
          ...
          <View style={{ display: 'flex', flexDirection: 'column', width: '30%', justifyContent: 'flex-end' }}>
            ...
            <Text style={{ fontSize: 10, marginTop: 6, textAlign: 'right' }}>{buyer.name}</Text>
          </View>
        </View>
      </View>
    </>
